...
plot_peak_time_courses(stc, plot_dict, save_path, save=True)
...
# plot_it_all('w0', 'w15', 14, 30, 0.000, 0.200, roi='CL6',
#             stc_indices=stc_indices, src_indices=src_indices, src=src,
#             lims=(0.010, 0.012, 0.014))
...
plot_it_all('o0', 'o15', 14, 30, 0.000, 0.200, roi='TH_R',
            stc_indices=stc_indices, src_indices=src_indices, src=src) 

plot_it_all('o0', 'o15', 14, 30, 0.000, 0.200, roi='CL6',
            stc_indices=stc_indices, src_indices=src_indices, src=src,
            lims=(0.010, 0.015, 0.020))    

plot_it_all('o0', 'o15', 14, 30, 0.000, 0.200, roi='CL1',
            stc_indices=stc_indices, src_indices=src_indices, src=src,
            lims=(0.010, 0.015, 0.020)) 
...
for weight_norm in weight_norms:
    ...
    ga_path_1 = fname.source_hilbert_beamformer_grand_average(
        subject=subject,
        date=date,
        fmin=fmin, fmax=fmax, tmin=-0.750, tmax=0.750, reg=0.00,
        event=combination['event'], first_event=combination['first_event'],
                    ...
                    weight_norm=weight_norm,
                    n_layers=1)
    ga_path_2 = fname.source_hilbert_beamformer_grand_average(
        subject=subject,
        date=date,
        fmin=fmin, fmax=fmax, tmin=-0.750, tmax=0.750, reg=0.00,
        event=combination['second_event'], first_event=combination['first_event'],
